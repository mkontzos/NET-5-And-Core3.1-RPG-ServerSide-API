    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Description = "Standard Authorization header using the Bearer scheme. Example: \"beare {token}\"",
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("DotNet-Rpg"));
